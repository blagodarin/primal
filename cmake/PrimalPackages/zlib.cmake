...
function(primal_provide_zlib _output)
	...
	primal_download("https://zlib.net/${_package}.tar.xz"
		SHA1 "e1cb0d5c92da8e9a8c2635dfa249c341dfd00322"
		EXTRACT_DIR "${_package}"
		PATCH ${_patch}
		RESULT _downloaded)
	set(_install_dir ${PRIMAL_PACKAGE_DIR}/zlib)
	if(_downloaded OR NOT EXISTS ${_install_dir})
		...
		message(STATUS "[PRIMAL] Provided ZLIB at ${_install_dir}")
		if(_arg_SET_UPDATED)

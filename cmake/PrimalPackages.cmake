...
function(_primal_cmake _source_dir _build_dir _install_dir)
	...
	if(_is_multi_config)
		execute_process(COMMAND ${CMAKE_COMMAND} --build ${_build_dir} --target ${_target} --parallel --config Debug COMMAND_ERROR_IS_FATAL ANY)
		execute_process(COMMAND ${CMAKE_COMMAND} --build ${_build_dir} --target ${_target} --parallel --config Release COMMAND_ERROR_IS_FATAL ANY)
	else()
		execute_process(COMMAND ${CMAKE_COMMAND} --build ${_build_dir} --target ${_target} --parallel COMMAND_ERROR_IS_FATAL ANY)
	endif()
endfunction()
